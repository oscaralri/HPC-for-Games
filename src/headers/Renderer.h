...
private:
	...
	void GenerateInstancedEntity(std::vector<std::string>& modelPaths, RandomGenerator random, glm::vec3 rotation, glm::vec3 scale, int lodIncrement, int numEntities);
