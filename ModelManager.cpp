...
ResourceHandle ModelManager::LoadModel(const std::string& path, bool gamma = false)
{
...
std::vector<Texture> ModelManager::loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName)
{
	std::vector<Texture> textures;
